...
8.  Delete a stack com o comando `docker stack rm vote`
   ![](img/2.png)
9.  Este exercício consumiu bastante espaço de disco nos nós em que foi feito o deploy. Vamos fazer o deploy de uma stack para executar o comando docker system prune em todos os nós do cluster. Para executar rode os comandos abaixo no codespaces.
    ```
